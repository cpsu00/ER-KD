...
# RankKD CFG
CFG.RankKD = CN()
CFG.RankKD.TEMPERATURE = 4
CFG.RankKD.LOSS = CN()
# CFG.RankKD.LOSS.CE_WEIGHT = 0.1
# CFG.RankKD.LOSS.KD_WEIGHT = 0.9
CFG.RankKD.LOSS.CE_WEIGHT = 1.0
CFG.RankKD.LOSS.KD_WEIGHT = 1.0
CFG.RankKD.LOSS.RK_WEIGHT = 3.0

# DIST CFG
CFG.DIST = CN()
CFG.DIST.TEMPERATURE = 4
CFG.DIST.LOSS = CN()
CFG.DIST.LOSS.CE_WEIGHT = 1.0
CFG.DIST.LOSS.KD_WEIGHT = 1.0
CFG.DIST.LOSS.beta = 1.0
CFG.DIST.LOSS.gamma = 1.0
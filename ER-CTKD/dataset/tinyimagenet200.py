...
tinyimagenet200_list = ['tinyimagenet200', 'tinyimagenet200te']


def get_data_folder(dataset='tinyimagenet200'):
    """
...
def get_test_loader(dataset='tinyimagenet200', batch_size=128, num_workers=8):
    """get the test data loader"""

    if dataset in tinyimagenet200_list:
...
def get_tinyimagenet200_dataloader(dataset='tinyimagenet200', batch_size=128, num_workers=16,
                            multiprocessing_distributed=False):
    """
    Data Loader for tinyimagenet200
    """
    if dataset in tinyimagenet200_list:
        data_folder = get_data_folder(dataset)
    else:
